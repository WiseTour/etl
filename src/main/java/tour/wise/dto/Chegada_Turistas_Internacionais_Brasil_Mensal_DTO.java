...
public class Chegada_Turistas_Internacionais_Brasil_Mensal_DTO {
    private Integer mes;
    private Integer ano;
    ...
    public Chegada_Turistas_Internacionais_Brasil_Mensal_DTO() {
    }


    public Chegada_Turistas_Internacionais_Brasil_Mensal_DTO(Integer mes, Integer ano, Integer chegadas, String via_acesso, String uf_destino, String pais_origem) {
        this.mes = mes;
        this.ano = ano;
